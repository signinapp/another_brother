...
#import <TbSendCommandMethodCall.h>

@implementation TbSendCommandMethodCall

static NSString * METHOD_NAME = @"typeB-sendCommand";
...
- (void)execute {
    ...
    dispatch_queue_t queue = dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0ul);
            dispatch_async(queue, ^{
                ...
                NSString * command = self->_call.arguments[@"command"];
